...
See the parent repository's [CLAUDE.md](../../CLAUDE.md) ("CLAUDE.md" at <https://github.com/Digital-Domain-Technologies-Ltd/MX-hub/blob/main/CLAUDE.md>) and [mx-config/system/GIT-README.md](../../mx-config/system/GIT-README.md) ("Git Workflow Guide for AI Agents" at <https://github.com/Digital-Domain-Technologies-Ltd/MX-hub/blob/main/mx-config/system/GIT-README.md>) for comprehensive guidance.

## Overview

These appendices support both "The Bible" (comprehensive guide) and "MX-Handbook" (practical guide). They provide:
...
See [docs/for-ai/writing-style.md](../../docs/for-ai/writing-style.md) ("Writing Style Guide: MX Series" at <https://github.com/Digital-Domain-Technologies-Ltd/MX-hub/blob/main/docs/for-ai/writing-style.md>) for complete guidelines.
